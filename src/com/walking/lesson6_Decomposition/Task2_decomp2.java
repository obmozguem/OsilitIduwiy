package com.walking.lesson6_Decomposition;

import java.util.Scanner;

/*Декомпозировать задачу com.walking.lesson14_polimorfism.task1.Nov12_ConditionalConstructs/Task4_Cisla2 ( Scanner sc = new Scanner(System.in);
        int a = sc.nextInt();
        int b = sc.nextInt();
        if (a % 2 == 0 && a % 3 == 0) {
